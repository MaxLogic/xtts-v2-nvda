...
addon_info = {
	...
	"addon_changelog": _("""Add Clone Voice with multiple recordings and conditioning settings; announce tab loading, open voice folders, and stream and cache previews."""),
